...
const EDGE_URL='https://pvnfwippvojplzedbnba.supabase.co/functions/v1/ravi-os-journal'

export async function journalAction(action:string,payload:Record<string,unknown>={}){
