...
const EDGE_URL='https://pvnfwippvojplzedbnba.supabase.co/functions/v1/ravi-os-control'

export async function controlAction(action:string,payload:Record<string,unknown>={}){
