...
const EDGE_URL='https://pvnfwippvojplzedbnba.supabase.co/functions/v1/ravi-os-waiting-for'

export async function waitingForAction(action:string,payload:Record<string,unknown>={}){
