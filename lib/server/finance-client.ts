...
const EDGE_URL='https://pvnfwippvojplzedbnba.supabase.co/functions/v1/ravi-os-finance'

export async function financeAction(action:string,payload:Record<string,unknown>={}){
